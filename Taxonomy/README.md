...
## Evaluation Results on G-TransEval
The translation generated by CodeT5, TransCoder and TransCoder-ST together with their results of unit tests are placed in the [BenchmarkResults](../G-TransEval/BenchmarkResults) folder.
