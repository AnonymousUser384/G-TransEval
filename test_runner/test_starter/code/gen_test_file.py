...
if __name__ == "__main__":
    langs = ["cpp", "java", "csharp", "javascript", "php", "python"]
    dataset = "collection_queries"

    for lang in langs:
        test_file = "../../target_file/test"+suffix(lang)
        codes = []
        ...
        for i in range(len(codes)):
            gen_test_file(lang, dataset, "distinct_odd_ration", codes[i])
